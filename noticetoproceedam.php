...
<nav class="navbar navbar-expand-lg" style="background-color:#1E73BE; margin-top:0.1em;">
  <div class="container-fluid">
    ...
    <li class="nav-item d-flex">
         ...
         <li class="nav-item d-flex">
          <a  style="font-size:14px; color:white" class="nav-link " href="index.php">RESULT OF THE OPENING OF BIDS</a>
        </li>
        <li  class="nav-item d-flex">
        ...
        <li class="nav-item">
          <a style="font-size:14px; color:white" class="nav-link active" href="#">NOTICE TO PROCEED-ALTERNATIVE MODE</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-12">
          <div class="card text-center ">
            <div class="card-header">
              <h3 class="card-title">NOTICE TO PROCEED-ALTERNATIVE MODE</h3>
            </div>
            <div class="card-body card-body-success ">
              <div class="table-responsive">
                <table id="showTable3" class="table table-bordered table-striped" style="border:1px solid gray;">
                  <thead>
                    <tr>
                      <th>File Name</th>
                      <th>Date Upload</th>
