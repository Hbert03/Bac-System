...
<nav class="navbar navbar-expand-lg" style="background-color:#1E73BE; margin-top:0.1em;">
  <div class="container-fluid">
    ...
    <li class="nav-item d-flex">
        ...
        <li   class="nav-item d-flex">
          <a style="font-size:14px; color:white" class="nav-link active" href="#">PUBLIC BIDDING</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-12">
          <div class="card text-center ">
            <div class="card-header">
              <h3 class="card-title">PUBLIC BIDDING</h3>
            </div>
            <div class="card-body card-body-success ">
              <div class="table-responsive">
                <table id="showTable1" class="table table-bordered table-striped" style="border:1px solid gray; overflow-x:hidden">
                  <thead>
                    <tr>
                      <th>File Name</th>
                      <th>Date Upload</th>
